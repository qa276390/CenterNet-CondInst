...
class MtsegDetector(BaseDetector):
    ...
    def process(self, images, return_time=False):
        with torch.no_grad():
            ...
            dets, masks, _, _, _ = mtseg_decode(hm, wh, saliency_map, local_shape, reg=reg, cat_spec_wh=self.opt.cat_spec_wh, K=self.opt.K, cat_spec_smap=self.opt.smap_class_specify)
